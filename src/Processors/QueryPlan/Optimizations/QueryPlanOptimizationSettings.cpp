...
namespace Setting
{
    ...
    extern const SettingsBool optimize_aggregation_in_order_limit_pushdown;
    ...
    bool is_parallel_replicas_initiator_with_projection_support_)
{
    ...
    aggregation_in_order_limit_pushdown = aggregation_in_order && read_in_order && from[Setting::optimize_aggregation_in_order_limit_pushdown];
