    ...
    bool merge_is_needed)
{
    ...
    /// Derive the serialization (sparse vs dense) of the projection columns from implicit statistics
    /// computed over the projection block, the same way the main part does in `writeTempPartImpl`.
