...
TEST_F(NormalizeTimeSeriesDefinitionTest, DefaultDefinition)
{
    ...
    EXPECT_TRUE(definition.contains("version = 5")) << definition;
    ...
    String samples_columns = "`id` " + default_id_type + ", `timestamp` DateTime64(3) CODEC(PFor('double_delta')), `value` Float64 CODEC(ZSTD(3))";
...
TEST_F(NormalizeTimeSeriesDefinitionTest, TypesDeclaredInInnerColumns)
{
    ...
    EXPECT_EQ(extractInnerColumns(definition, "RECENT SAMPLES"),
        "`id` UInt64, `timestamp` DateTime64(6) CODEC(PFor('double_delta')), `value` Float32 CODEC(ZSTD(3))");
...
TEST_F(NormalizeTimeSeriesDefinitionTest, IdTypeSetting)
{
    ...
    EXPECT_EQ(extractInnerColumns(definition, "SAMPLES"), "`id` UInt64, `timestamp` DateTime64(3) CODEC(PFor('double_delta')), `value` Float64 CODEC(ZSTD(3))");
    EXPECT_TRUE(extractInnerColumns(definition, "TAGS").starts_with("`id` UInt64 DEFAULT sipHash64(tags), ")) << definition;
...
TEST_F(NormalizeTimeSeriesDefinitionTest, OuterColumns)
{
    ...
    EXPECT_EQ(extractInnerColumns(definition, "SAMPLES"),
        "`id` " + default_id_type + ", `timestamp` UInt32 CODEC(PFor('double_delta')), `value` Float32 CODEC(ZSTD(3))");
...
TEST_F(NormalizeTimeSeriesDefinitionTest, CreateAsCopiesInnerDefinitions)
{
    ...
    EXPECT_EQ(extractInnerColumns(definition, "SAMPLES"), "`id` UInt64, `timestamp` DateTime64(6) CODEC(PFor('double_delta')), `value` Float32");
    EXPECT_EQ(extractInnerColumns(definition, "RECENT SAMPLES"), "`id` UInt64, `timestamp` DateTime64(6) CODEC(PFor('double_delta')), `value` Float32 CODEC(ZSTD(3))");
    EXPECT_EQ(extractInnerColumns(definition, "TAGS"),
        "`id` UInt64 DEFAULT sipHash64(tags), `metric_name` LowCardinality(String), `tags` Map(LowCardinality(String), String), "
    ...
    EXPECT_EQ(extractInnerColumns(definition, "RECENT SAMPLES"), "`id` UInt64, `timestamp` DateTime64(6) CODEC(PFor('double_delta')), `value` Float64 CODEC(ZSTD(3))");
}
...
TEST_F(NormalizeTimeSeriesDefinitionTest, CreateAsTableWithExternalTargetTables)
{
    ...
    EXPECT_EQ(extractInnerColumns(definition, "SAMPLES"),
        "`id` UInt64, `timestamp` DateTime64(6) CODEC(PFor('double_delta')), `value` Float64 CODEC(ZSTD(3)), `extra` UInt8");
    EXPECT_EQ(extractInnerColumns(definition, "TAGS"),
