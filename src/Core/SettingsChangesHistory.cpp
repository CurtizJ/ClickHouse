...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.5",
        {
            ...
            {"optimize_aggregation_in_order_limit_pushdown", false, true, "New setting to push LIMIT through GROUP BY into the in-order aggregation pipeline so that MergeTree stops reading once enough distinct groups have been seen."},
        });
