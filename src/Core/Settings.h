...
#define COMMON_SETTINGS(M, ALIAS) \
    ...
    M(Bool, optimize_read_in_order_analyze_condition, true, "IF true analyze condition and disable 'optimize_read_in_order if condition presumably has high selectivity", 0) \
