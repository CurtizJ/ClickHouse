...
#define APPLY_FOR_BUILTIN_EVENTS(M) \
    ...
    M(MergedTextIndexes, "Number of text indexes merged (not rebuilt) during MergeTree merges.", ValueType::Number) \
    M(RebuiltTextIndexes, "Number of text indexes rebuilt from scratch during MergeTree merges.", ValueType::Number) \
