...
/// BinaryTypeIndex enum is now defined in DataTypesBinaryEncoding.h
...
DataTypePtr decodeDataType(ReadBuffer & buf, size_t & complexity)
{
    ...
    switch (BinaryTypeIndex(type))
    {
        ...
        case BinaryTypeIndex::Date32:
            return getSimpleDataTypeCache().getType(BinaryTypeIndex(type));
        case BinaryTypeIndex::Bool:
            return getSimpleDataTypeCache().getType(BinaryTypeIndex::Bool);
        ...
        case BinaryTypeIndex::String:
            return getSimpleDataTypeCache().getType(BinaryTypeIndex::String);
        case BinaryTypeIndex::FixedString:
        {
            UInt64 size;
            readVarUInt(size, buf);
        ...
        case BinaryTypeIndex::UUID:
            return getSimpleDataTypeCache().getType(BinaryTypeIndex::UUID);
        case BinaryTypeIndex::Array:
        ...
        case BinaryTypeIndex::IPv4:
            return getSimpleDataTypeCache().getType(BinaryTypeIndex::IPv4);
        case BinaryTypeIndex::IPv6:
            return getSimpleDataTypeCache().getType(BinaryTypeIndex::IPv6);
        case BinaryTypeIndex::Variant:
        {
            size_t size;
            readVarUInt(size, buf);
