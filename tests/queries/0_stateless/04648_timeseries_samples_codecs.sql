...
-- (`PFor('double_delta')` for timestamps since version 5 of the table engine, `DoubleDelta, ZSTD(1)` before it,
-- plain ZSTD for values). The generation of the codecs is covered by the unit test
