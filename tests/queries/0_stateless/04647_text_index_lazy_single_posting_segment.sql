...
--   * `text_index_postings_cursor_intersection_algorithm = 'leapfrog'` forces the leapfrog intersection,
...
SETTINGS text_index_posting_list_apply_mode = 'lazy',
         text_index_postings_cursor_intersection_algorithm = 'leapfrog',
...
WHERE hasAllTokens(s, ['aaa', 'bbb'])
SETTINGS text_index_posting_list_apply_mode = 'lazy',
         text_index_postings_cursor_intersection_algorithm = 'bruteforce',
         query_plan_direct_read_from_text_index = 1,
         use_skip_indexes = 1,
         use_skip_indexes_on_data_read = 1,
